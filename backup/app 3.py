...
def generate_biography_draft():
    ...
    try:
        ...
        model = data.get('model', 'both')  # 'deepseek', 'claude', or 'both'
...
def generate_biography_pdf_route():
    ...
    try:
        ...
        pdf_buffer = generate_biography_pdf(
            ...
            subtitle,
            UPLOAD_FOLDER,
            hero_photo=None  # TODO: Add hero photo selection
        )
        ...
        return send_file(
            ...
            as_attachment=True,
            download_name=f'family_biography_{title.replace(" ", "_").lower()}.pdf'
        )
